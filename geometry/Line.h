...
public:
     ...
     */
    bool IntersectionWithCircle(const Point& centre, double radius = 0.30 /*m for pedestrians*/) const;
    ...
    // return the intersection point with a circle
    void pointIntersectionWithCircle(std::vector<Point> & interP, const Point& centre, double radius);
