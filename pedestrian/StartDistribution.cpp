...
void StartDistribution::SetCircle(bool c)
{
    _circle = c;
}

bool StartDistribution::GetCircle() const
{
    return _circle;
}

void StartDistribution::SetRadius(float r)
{
    _radius = r;
}

float StartDistribution::GetRadius() const
{
    return _radius;
}
